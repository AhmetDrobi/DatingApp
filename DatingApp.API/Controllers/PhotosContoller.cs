...
namespace DatingApp.API.Controllers
{
    ...
    public class PhotosContoller : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddPhotoForUser(int userId, [FromForm]
    PhotoForCreationDto photoForCreationDto)
        {
            ...
            var photo = _mapper.Map<Photo>(photoForCreationDto); //Map the Dto object to the photo model
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            return BadRequest("Couldn not set photo to main");
        }
